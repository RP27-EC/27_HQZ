...
/* Private macro -------------------------------------------------------------*/
#define USART5_RX_DATA_FRAME_LEN	(18u)	// 串口2数据帧长�?
#define USART5_RX_BUF_LEN			(USART5_RX_DATA_FRAME_LEN)	// 串口2接收缓冲区长�?
...
void USART5_Init(void)
{
	...
	USART_DMAEx_MultiBuffer_Init(&huart5, (uint32_t*)&usart5_dma_rxbuf[0], \
							    (uint32_t*)&usart5_dma_rxbuf[1], USART5_RX_BUF_LEN); // 接收完毕后重�?
#endif
}
